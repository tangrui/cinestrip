jest.setMock(
  'nconf/lib/nconf/provider',
  require.requireActual('../__mocks__/nconf/lib/nconf/provider')
)
jest.dontMock('..')

describe('config', () => {
  it('should fetch configuration from various resources', () => {
    ...
    expect(config.file.mock.calls[0]).toEqual([
      'app_env',
